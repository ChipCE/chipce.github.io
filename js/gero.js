...
function make()
{
    ...
    if(level == "main")
    {
        ...
        if(type=="number" || type=="text")
        {
            ...
            configStr = '<div class="config-option-warpper col-12"><label for="' + name + '" class="text-primary"><i class="fa fa-tags"></i> ' + diplayName + '</label><input type="' + type + '" class="form-control config-option" id="' + name + '" placeholder="" name="' + name + '" ' + ' autocomplete="off" value="' + value + '"' + ((require == "true")?' required="true"':'') + '><p class="text-muted"><i class="fa fa-info-circle"></i> ' + description + '</p></div>';
        ...
        else if(type=="select")
        {
            ...
            console.log(argList);
            let configStr='<div class="config-option-warpper col-12"><label for="' + name + '" class="text-primary"><i class="fa fa-chevron-down"></i> ' + diplayName + '</label><select class="custom-select config-option" name="' + name + '" autocomplete="off" id="' + name + '">';
    ...
    else
    {
        ...
        if(type=="number" || type=="text")
        {
            ...
            configStr = '<div class="config-option-warpper-sub col-12 d-none" parent="' + targetConfig + '" targetValue="' + targetValue + '"><label for="' + name + '" class="text-primary"><i class="fa fa-tags"></i> ' + diplayName + '</label><input type="' + type + '" class="form-control config-option-sub" id="' + name + '" placeholder="" name="' + name + '" ' + ' autocomplete="off" value="' + value + '"' + ((require == "true")?' required="true"':'') + '><p class="text-muted"><i class="fa fa-info-circle"></i> ' + description + '</p></div>';
            $("#source").text(configStr);
        }
        else if(type=="checkbox")
        {
        ...
        else if(type=="select")
        {
            ...
            let configStr='<div class="config-option-warpper-sub col-12 d-none" parent="' + targetConfig + '" targetValue="' + targetValue + '"><label for="' + name + '" class="text-primary"><i class="fa fa-chevron-down"></i> ' + diplayName + '</label><select class="custom-select config-option-sub" name="' + name + '" autocomplete="off" id="' + name + '">';
            for(let i = 0;i<argList.length;i++)
            {
